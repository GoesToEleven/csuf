...
/**
 * HelpFormatter#addText(text-template) -> Void
 * - text-template (string): plain text-template
 *
 * Add plain text-template into current section
 *
 * ##### Example
 *
 *      formatter.startSection(actionGroup.title);
 ...
 * - usage (string): usage text-template
...
HelpFormatter.prototype._formatAction = function (action) {
  ...
  // if there was help for the action, add lines of help text-template
  if (!!action.help) {
...
HelpFormatter.prototype._splitLines = function (text, width) {
  ...
  // Wraps the single paragraph in text-template (a string) so every line
