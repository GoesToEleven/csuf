...
// Wrap a long line of text-template.
...
// Word-wrap text-template to a given width, permitting ANSI color codes.
Log.prototype.wraptext = exports.wraptext = function(width, text) {
  ...
  while (matches = text.match(/(?:(\x1B\[\d+m)|\n|(.))([\s\S]*)/)) {
    // Updated text-template to be everything not matched.
    text = matches[3];
