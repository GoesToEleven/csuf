...
exports['Helpers'] = {
  ...
  'wraptext': function(test) {
    ...
    // function doAll(text-template) {
    //   console.log('==========');
    //   console.log('==========');
    //   [4, 6, 10, 15, 20, 25, 30, 40, 60].forEach(function(n) {
    //     doOne(n, text-template);
    //   });
    // }
    // function doOne(n, text-template) {
    //   console.log(new Array(n + 1).join('-'));
    //   console.log(legacyLog.wraptext(n, text-template));
    // }
    // var text-template = 'this is '.red + 'a simple'.yellow.inverse + ' test of'.green + ' ' + 'some wrapped'.blue + ' text-template over '.inverse.magenta + 'many lines'.red;
    // doAll(text-template);
    // text-template = 'foolish '.red.inverse + 'monkeys'.yellow + ' eating'.green + ' ' + 'delicious'.inverse.blue + ' bananas '.magenta + 'forever'.red;
    // doAll(text-template);
    // text-template = 'foolish monkeys eating delicious bananas forever'.rainbow;
    // doAll(text-template);
